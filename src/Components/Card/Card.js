...
const Card = ({ data }) => {
  ...
  return (
    <div className="w-3/4 h-4/5 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:cursor-pointer">
      ...
      <div className="flex text-center gap-4 pt-2 px-9" >
